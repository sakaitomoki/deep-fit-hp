...
const scheduleBlocks: Record<string, ScheduleBlock[]> = {
  mon: [
    ...
    { start: 13.5, end: 16.5, label: "フリー", color: "free" },
    { start: 16.5, end: 17.5, label: "キッズクラス", color: "kids" },
    { start: 17.5, end: 22,   label: "フィットネス", color: "fitness" },
  ],
  tue: [
    { start: 6,    end: 10,   label: "フリー", color: "free" },
    { start: 10,   end: 13.5, label: "フィットネス", color: "fitness" },
      ...
      <section className="py-20 lg:py-28 bg-[#FAF5EE]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[#4D5058]/40 text-xs mt-2">
            ※ フリーは会員様の同伴のみドロップイン可能なジム開放時間です。対人クラスもドロップイン可（各1回1,100円）。パーソナルトレーニングは要予約。キッズクラスは月曜16:30〜17:30・火曜17:00〜18:00・土曜14:00〜15:00。祝日定休。
          </p>
        </div>
      </section>
