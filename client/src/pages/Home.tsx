...
const faqItems = [
  ...
  },
  {
    ...
    aBody: "室内シューズ・タオル・飲み物があると快適ですが、手ぶらでも対応できます。グローブなどの道具は不要です。",
  },
  {
    q: "どれくらいで効果を実感できますか？",
    aLead: "週2〜3回のペースで、1ヶ月ほどで変化を感じる方が多いです。",
    aBody: "体力の向上や気分の変化は比較的早く感じていただけます。焦らず自分のペースで続けられる環境を整えています。",
  },
  {
    q: "キッズクラスはありますか？",
    aLead: "はい、お子さま向けのクラスをご用意しています。",
    aBody: "楽しみながら体を動かすプログラムで、礼儀やスポーツの基礎も学べます。お子さまと一緒に通われているご家庭もありますので、お気軽にご相談ください。",
  },
  {
    q: "退会やお休みはできますか？",
