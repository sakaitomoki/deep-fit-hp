...
export const home: Record<string, string> = {
  ...
  "今日": "Today",
  "ご連絡ありがとうございます！体験のご予約ですね😊": "Thanks for reaching out! You'd like to book a trial 😊",
  "ご希望の日にち・時間帯はありますか？": "Do you have a preferred date and time?",
  "土曜の17時は空いてますか？": "Is Saturday at 5pm available?",
  "土曜17:00〜、空いております♪": "Saturday from 17:00 is open ♪",
  "お名前と人数を教えていただけますか？": "Could you tell us your name and number of people?",
  "1名でお願いします！": "Just one person, please!",
  "ありがとうございます！当日は動きやすい服装・飲み物・タオル・軍手をお持ちください。": "Thank you! On the day, please bring comfortable clothes, a drink, a towel, and work gloves.",
  "裸足で行うので靴下は脱いでいただきます🧦": "We train barefoot, so you'll take off your socks 🧦",
  "体験料は無料です！": "The trial is free!",
