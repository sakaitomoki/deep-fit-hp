...
export const home: Record<string, string> = {
  ...
  "今日": "Today",
  "土曜17時に体験予約したいです！": "I'd like to book a trial for Saturday at 5pm!",
  "ありがとうございます😊 土曜17時〜で承りました✨": "Thank you 😊 You're booked for Saturday from 17:00 ✨",
  "運動が苦手な方や初めての女性がほとんどなので、安心してお越しくださいね🙆‍♀️": "Most of our members aren't sporty or are first-time women, so please come with peace of mind 🙆‍♀️",
  "持ち物は動きやすい服装とお飲み物だけでOK！お待ちしています🥊": "Just bring comfortable clothes and a drink — that's all! See you there 🥊",
