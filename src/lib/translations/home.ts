...
export const home: Record<string, string> = {
  ...
  "特典⑤": "Perk 5",
  "女性限定": "Women Only",
  "🗓 9月・10月限定": "🗓 September & October Only",
  "👩 女性限定": "👩 Women Only",
  "じっくり通える": "Take your time to settle in",
  "3回体験": "3-Session Trial",
  "ご入会いただくと全額返金！": "Get a full refund when you join!",
  "※入会後、体験料3,300円を全額返金いたします。": "* The ¥3,300 trial fee is fully refunded after you enroll.",
  "乗り換え限定": "Switch & Save",
  "🔄 他ジムご利用中の方へ": "🔄 For current gym members",
  "ジム乗り換えキャンペーン": "Gym Switch Campaign",
  "会員証・アプリ画面のご提示で": "Show your membership card or app screen and get:",
  "※ご入会時に他ジムの会員証またはアプリ画面をご提示ください。": "* Please show your other gym's membership card or app screen when you enroll.",
  ...
  "続けやすい！": "Easy to keep up!",
  "＼ 半年以上継続するなら ／": "If you continue for 6+ months",
  "DEEPライト会員": "DEEP Light Membership",
  "（税込 12,100円/月）": "(incl. tax ¥12,100/mo)",
  "※半年以上の継続を前提としたプランです。": "* This plan assumes at least six months of continued membership.",
  "スタンダードコース": "Standard Course",
  "＼ 縛りなしで気軽に ／": "No commitment, join anytime",
  "DEEPスタンダード会員": "DEEP Standard Membership",
  "フルタイム": "Full Time",
  "月8回": "8 Times/Month",
  "（税込 13,200円/月）": "(incl. tax ¥13,200/mo)",
  "（税込 11,000円/月）": "(incl. tax ¥11,000/mo)",
  "※継続の縛りはありません。いつでも退会可能です。": "* No minimum commitment. Cancel anytime.",
  "今日": "Today",
  "体験予約したいです！": "I'd like to book a trial!",
  "初めまして、ご連絡ありがとうございます😊✨": "Hi there, thanks so much for reaching out 😊✨",
  "体験のご予約ですね！ご希望の日時はありますか？😆": "A trial booking — great! Do you have a preferred date and time? 😆",
  "土曜の17時は空いてますか？": "Is Saturday at 17:00 available?",
  "土曜17時〜、空いております✨😊": "Saturday from 17:00 is open ✨😊",
  "そちらでご予約承りますね！🙆‍♀️": "We'll book you in for that! 🙆‍♀️",
  ...
  "当日は動きやすい服装とお飲み物だけでOKです👟💧": "On the day, just comfortable clothes and a drink 👟💧",
  "ご質問等ありましたらお気軽にお声掛けくださいね😊 お待ちしています🥊": "If you have any questions, feel free to reach out anytime 😊 See you there 🥊",
  "運動がとても苦手なのですが、女性でも通えますか？": "I'm really not good at exercise — can women join too?",
  "もちろんです😊 女性の会員さんもたくさん通われています✨": "Of course 😊 Lots of our members are women ✨",
  "運動が苦手な方や初めての方がほとんどなので、安心してくださいね🙆‍♀️": "Most people here aren't sporty or are complete beginners, so please don't worry 🙆‍♀️",
  "体力に自信がなくて、続けられるか不安です💦": "I'm not confident in my stamina and worried I can't keep it up 💦",
  "大丈夫です！お一人おひとりのペースに合わせるので無理はありません😊": "You'll be fine! We go at each person's own pace, so you won't overdo it 😊",
  "きつすぎない範囲で、スタッフが一からサポートします✨": "We keep it manageable and support you from the very basics ✨",
  "持ち物は何が必要ですか？": "What do I need to bring?",
  "動きやすい服装とお飲み物だけでOKです！": "Just comfortable clothes and a drink!",
  "シューズも不要なので、手ぶら感覚でお越しいただけます👟": "No shoes needed either, so you can come practically empty-handed 👟",
  "それなら私でもできそう…体験してみたいです！": "Then maybe even I can do it… I'd like to try!",
  "ありがとうございます😊 体験は無料です！": "Thank you 😊 The trial is free!",
  "ご希望の日時をこのままLINEで送ってくださいね✨ お待ちしています🥊": "Just send your preferred date & time here on LINE ✨ We look forward to seeing you 🥊",
  "土曜日17時から体験可能ですか？": "Can I do a trial on Saturday from 5pm?",
  "ありがとうございます😊": "Thank you 😊",
  "土曜日17時〜、体験予約承ります✨": "Saturday from 17:00 — your trial is booked ✨",
  "運動不慣れな方も多く通われてるので、体力に自信なくても全然大丈夫です🙆‍♀️": "Lots of our members aren't used to exercise, so no worries if you're not confident in your fitness 🙆‍♀️",
  "スタッフが一からサポートするのでご安心ください✨": "Our staff support you from the very basics, so please relax ✨",
  "当日の持ち物は動きやすい服装・お飲み物だけでOKです！": "On the day, just bring comfortable clothes and a drink!",
  "シューズ等は不要です🙆": "No shoes needed 🙆",
  "初めては緊張しますよね💦": "It's natural to feel nervous your first time 💦",
  "分からないことは当日何でも聞いてください🥊✨": "Ask us anything on the day 🥊✨",
  "ご質問等ありましたらお気軽にお声掛けくださいね😊": "If you have any questions, feel free to reach out anytime 😊",
  "夏の大キャンペーン": "Summer Mega Campaign",
  "夏の終わりが、カラダ作りの始まり。": "The end of summer is the start of building your body.",
